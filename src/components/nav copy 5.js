...
class Nav extends Component {
  state = {
    ...
    mediaObjects: {
      hnk: { story: "story1", thoughts: "thoughts 1", review: "review 1" },
    },
    quotes: [""],
    authors: [""],
            ...
            <item>
              ...
              {this.state.handleMedia === true ? (
                <Card className="card-styling fade-in">
                  ...
                  <div>
                    {Object.values(this.state.mediaObjects[this.state.pv]).map(
                      (media, index) => (
                        ...
                        //    className={
                        //      this.state.pv ===
                        //      Object.keys(this.state.mediaObjects)[index]
                        //        ? "active"
                        //        : "inactive"
                        //    }
                        //  >
                        //    {
                        //      Object.values(this.state.mediaObjects)[0][
                        //        this.state.currCategory
                        //      ]
                        //    }
                        //  </div>
                  ...
                  {/* {this.state.currCategory === Object.values(this.state.mediaObjects)[0]["story"]} */}
